...
> **全表收录**：`data/processed/kl8_draws.csv` 共 **1933** 行，期号 **`2020012`–`2026123`**（溯源见 `data/processed/manifest.json`）
...
- `18（12）`、`39（12）`、`36（11）`、`46（11）`、`53（11）`

出现次数（Low5）：

- `22（3）`、`59（3）`、`73（3）`、`1（4）`、`8（4）`

当前遗漏（Top5，截至窗口末 `2026123`）：

- `73（17期）`、`13（12期）`、`59（12期）`、`79（12期）`、`5（8期）`

### 2) 每期 20 码和值与跨度（窗口内）

- 20 码和值：均值 816.17，中位数 815，Q1–Q3 约 770–866
- 20 码跨度（max−min）：均值 72.63，中位数 74，Q1–Q3 约 70–76

### 3) 每期 20 码中「奇数个数」主结构（Top3）

- `10奇/10偶`（9期）, `9奇/11偶`（7期）, `12奇/8偶`（5期）
