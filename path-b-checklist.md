...
| 3.5 | 快乐八：**参考开奖 20 码（升序）** + **选十参考 11 码（升序）**（机械口径为**区间掩码马尔可夫单一路径**，见 `interval_markov.py` / `prediction_block_kl8`；也可 `use_mask=False` 全号池） | 同上 | ☐ `history/kuaileba_prediction.md` |
